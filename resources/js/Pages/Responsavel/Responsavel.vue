...
const filteredResponsavel = computed(() => {
  return responsavel.value.filter(resp => {
    const matchesDepa = !filterDepa.value || resp.departamento === filterDepa.value
    const matchesCargo   = !filterCargo.value || resp.cargo === filterCargo.value
    return matchesDepa && matchesCargo
  })
})
...
<template>
    <AuthenticatedLayout>
        <h4 class=""><strong>Funcionários (Responsáveis) </strong></h4>
         <div class="card  p-4 mb-2">
           ...
           <div class="d-flex flex-column flex-md-row gap-2 w-100">
                ...
                <div class="select-icon-wrapper equal-height">
                    ...
                    <select v-model="filterCargo" class="form-select form-select-sm">
        ...
        <div class="card p-4 ">
            ...
            <tbody>
                <tr v-for="resp in filteredResponsavel" :key="resp.id" :data-id="resp.id">
                <td></td>
                ...
                <td class="date-cell">{{ new Date(resp.created_at).toLocaleDateString() }}</td>
                <td>
        ...
        <div class="modal fade" id="modalRegistar" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel3">Registar Responsavel</h5>
                        <button
                        type="button"
                        class="btn-close"
                                ...
                                <div class="row g-2">
                                    <div class="col mb-0">
                                        <label for="emailLarge" class="">Cargo</label>
                                         <select v-model="form.cargo" class="form-select ">
                                        ...
                                        <div v-if="form.errors.cargo" class="text-red-500 text-sm mt-1">
                                            {{ form.errors.cargo }}
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal fade" id="modalEditar" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel3">Actualizar Responsavel</h5>
                        <button
                        type="button"
                        class="btn-close"
                        data-bs-dismiss="modal"
        ...
        <div class="modal fade" id="modalDetalhes" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel3">Detallhes do Responsavel</h5>
                        <button
                        type="button"
                        class="btn-close"
                        data-bs-dismiss="modal"
